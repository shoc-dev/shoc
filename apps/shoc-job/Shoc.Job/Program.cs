...
builder.Services.AddSingleton<JobResourceFormatter>();
builder.Services.AddSingleton<JobResourceAllocatorFactory>();
...
builder.Services.AddSingleton<KubernetesJobClientFactory>();
